...
var resize = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var reqFileName, reqWidth, reqHeight, fileFormat, fileExtension, srcFilePath, dstFileName, dstDir, dstFilePath, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                reqWidth = parseInt(req.query.width);
                reqHeight = parseInt(req.query.height);
                ...
                srcFilePath = path_1.default.join(__dirname + '../../../images/full/' + reqFileName + fileExtension);
                if (isNaN(reqWidth) || isNaN(reqHeight)) {
                    res.send("Error: Please enter valid number for width and height");
                    return [2 /*return*/];
                }
                dstFileName = reqFileName + reqWidth + reqHeight + fileExtension;
            ...
            case 1:
                ...
                return [4 /*yield*/, resizeJPEG_1.default(srcFilePath, reqWidth, reqHeight, dstFilePath)];
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
            case 3:
                if (!(fileFormat === 'png')) return [3 /*break*/, 5];
                return [4 /*yield*/, resizePNG_1.default(srcFilePath, reqWidth, reqHeight, dstFilePath)];
            case 4:
                _a.sent();
                _a.label = 5;
            case 5:
